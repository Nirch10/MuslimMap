...
data = {
    'person': ['al-Mu\'izz li-Din Allah'] * 5 + ['al-Aziz Billah'] * 5 + ['al-Hakim bi-Amr Allah'] * 9 +
...
colors = ['#607C3C', '#007F00', '#00CC00', '#B5E550', '#0000FF', '#00004C', '#6F00FF', '#FF4D00', '#0A2351', '#B9D9EB', '#00FF00', '#4C516D', '#007791', '#004C00', '#1877F2']
...
for person, group in df.groupby('person'):
    fig.add_trace(
        go.Scattermapbox(
            ...
            text=group['date'].dt.year,
            name=f"{person} (2D Map)",
        ),
        row=1, col=1
    )
    i+=1
